...
func applyDefaults(v *viper.Viper, d Config) {
	...
	v.SetDefault("telemetry.posthog.enabled", d.Telemetry.PostHog.Enabled)
	v.SetDefault("telemetry.posthog.endpoint", d.Telemetry.PostHog.Endpoint)
	v.SetDefault("telemetry.posthog.level", d.Telemetry.PostHog.Level)
	v.SetDefault("telemetry.posthog.flush_interval", d.Telemetry.PostHog.FlushInterval)
