...
Kafka, SQS, SNS — RabbitMQ is a stub today). It is designed to run as a
...
A stub today — returns `ErrNotImplemented` on `Publish`. Wiring up a real
implementation is tracked in the design docs.
