---
title: Substack feeds
type: how-to
tags: [rss2msg/docs, feeds, cms, substack]
summary: Find the RSS feed URL Substack publishes and point rss2msg at it.
updated: 2026-06-09
---

# Substack feeds

Substack publishes a feed at a predictable URL. rss2msg polls it like any other feed —
...
| Feed | URL |
| --- | --- |
| Newsletter | `https://<name>.substack.com/feed` |
