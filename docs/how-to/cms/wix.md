...
title: Wix feeds
type: how-to
tags: [rss2msg/docs, feeds, cms, wix]
summary: Find the RSS feed URL Wix publishes and point rss2msg at it.
updated: 2026-06-09
---

# Wix feeds

Wix publishes a feed at a predictable URL. rss2msg polls it like any other feed —
...
| Feed | URL |
| --- | --- |
| Blog | `https://site/blog-feed.xml` |

Available when the site uses the Wix Blog app.

## Add it to rss2msg

```yaml
feeds:
  - url: https://site.example.com/blog-feed.xml
    interval: 15m
    sinks: [default]
```
