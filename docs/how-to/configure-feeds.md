...
- [Get Feeds from CMS Platforms](get-feeds-from-cms-platforms.md) — feed URLs for WordPress, Ghost, Substack, and other common platforms.
- [Load Feeds Dynamically](load-feeds-dynamically.md) — reconcile the feed list at runtime from `feed_sources:`.
...
- [`config.example.full.yaml`](../../examples/config.example.full.yaml) — a comprehensive, runnable example with a large real-world feed list.
